...
if ($res1->num_rows == 1) { //若存在数据则更新
    ...
    //INSERT INTO gwc(id,uid,gid,username,num,price,imgurl,total,free,remain,title,argument) VALUES(4,4,4,'zfg',666,333,'shabi','577','a','1','a','0');
    // $sql5 = "UPDATE gwc set gid=$gid,username=$username,gnum=$gnum,price=$price,total=$total,title=$title,img=$img,kucun=$kucun WHERE gid='$gid' AND username='$username'";
    // $res5 = $GLOBALS['conn']->query($sql5); //结果集
